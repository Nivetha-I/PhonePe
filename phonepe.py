...
def animate_all_amount():
    ...
    fig_tra = px.choropleth(merged_df, geojson= 'https://gist.githubusercontent.com/jbrobst/56c13bbbf9d97d187fea01ca62ea5112/raw/e388c4cae20aa53cb5090210a42ebb9b765c0a36/india_states.geojson', locations= "States", featureidkey= "properties.ST_NM", color= "Transaction_amount",
   ...
   # return st.map(fig_tra)
    return st.plotly_chart(fig_tra,use_container_width=True)
...
def transaction_amount_year(sel_year):
    ...
    fig_atay= px.choropleth(atay3, geojson= data1, locations= "States", featureidkey= "properties.ST_NM",
                            color= "Transaction_amount", color_continuous_scale="Viridis", range_color=(0,3000000000),
...
def transaction_count_year(sel_year):
    ...
    fig_atcy = px.choropleth(df, geojson=response,
                    locations='iso_alpha',
                    color='pop',
...
with tab3:
    ques= st.selectbox("",('Top Brands Of Mobiles Used','States With Lowest Trasaction Amount',
